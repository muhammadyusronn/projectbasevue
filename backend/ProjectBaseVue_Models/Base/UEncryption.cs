...
public class UEncryption
{
    ...
    public static string Encrypt(string strToEncrypt)
    {
        try
        {
            return Encrypt(strToEncrypt, "itmKey").Replace("&", "itmKey");
        }
    ...
    public static string Decrypt(string strEncrypted)
    {
        try
        {
            strEncrypted = strEncrypted.Replace("itmKey", "&");
            return Decrypt(strEncrypted, "itmKey");
        }
        catch (Exception ex)
        {
            return "Wrong Input. " + ex.Message;
    ...
    public static class Base32
    {
        ...
        public static string Encode(string dataString, bool padOutput = false)
        {
