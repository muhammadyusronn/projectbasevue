<template>
    <div :class="containerClass" data-scrollselectors=".p-datatable-wrapper">
        ...
        <DTPaginator ref="paginatorTop" v-if="paginatorTop" :rows="d_rows" :first="d_first" :totalRecords="totalRecordsLength" :pageLinkSize="pageLinkSize" :template="paginatorTemplate" :rowsPerPageOptions="rowsPerPageOptions"
        ...
        <div class="p-datatable-wrapper" :class="wrapperClass"> <!--:style="{maxHeight: scrollHeight}" :style="{'height': scrollHeight}"-->
        ...
        <DTPaginator ref="paginatorBottom" v-if="paginatorBottom" :rows="d_rows" :first="d_first" :totalRecords="totalRecordsLength" :pageLinkSize="pageLinkSize" :template="paginatorTemplate" :rowsPerPageOptions="rowsPerPageOptions"
        ...
        goToLastPage(){
            if(this.paginator){
                if(this.paginatorTop){
                    this.$refs.paginatorTop.changePageToLast();
                }
                else if(this.paginatorBottom){
                    this.$refs.paginatorBottom.changePageToLast();
                }
            }
        },
        goToFirstPage(){
            if(this.paginator){
                if(this.paginatorTop){
                    this.$refs.paginatorTop.changePageToFirst();
                }
                else if(this.paginatorBottom){
                    this.$refs.paginatorBottom.changePageToFirst();
                }
            }
        },
