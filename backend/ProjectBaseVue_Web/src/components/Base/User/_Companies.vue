<template>
    <DataTable :loading="!header" :value="dataArray" responsiveLayout="scroll" class="p-datatable-sm editable-cells-table" :rowClass="hideRow">
        <Column >
            <template #header="">
        ...
        <Column field="Company_Id" :header="$t('company')" key="Company_Id" class="w-12">
            <template #body="slotProps">
                <CustomSelect 
                    v-model="slotProps.data[slotProps.column.props.field]" 
                    :url="$API_URL + 'list/company_id'" 
                    :minLength="0" 
                    :filter="true"
