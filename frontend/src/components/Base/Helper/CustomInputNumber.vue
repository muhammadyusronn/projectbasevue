...
export default {
    name: 'InputNumber',
    inheritAttrs: false,
    emits: ['update:modelValue', 'input', 'focus', 'blur', 'blur-data'],
    props: {
        modelValue: {
            type: Number,
            default: null
    ...
    updated(){
        var validateVal = this.validateValue(this.modelValue);
        this.updateModel(this, validateVal);
    },
    mounted(){
       
        if(this.max){
            this.updateModel(this, this.max); 
        }
    ...
    methods: {
        ...
        formatValue(value) {
            if (value != null) {
                ...
                if (this.format) {
                    ...
                    // console.log("Formatter Value: " + formatter);
        ...
        onInputKeyDown(event) {
            ...
            this.$ArrowNavigate.arrownavigate(event);
        ...
        insert(event, text, sign = { isDecimalSign: false, isMinusSign: false }) {
            ...
            //console.log("Is decimal sign: " + sign.isDecimalSign);
            ...
            if (sign.isMinusSign) {
                ...
                // console.log("Decimal Char Index: " + decimalCharIndex + ", Selection Start: " + selectionStart + ", MaxFractionDigits: " + maxFractionDigits);
                // console.log("Optional Decimal: " + this.optionalDecimal);
                
                if(this.optionalDecimal){
                    newValueStr = this.insertText(inputValue, text, selectionStart, selectionEnd);
        ...
        insertText(value, text, start, end) {
            ...
            //console.log("Value: " + value + ", Text: " + text + ", Start: " + start + ", End: " + end);
        ...
        onInputBlur(event) {
            ...
            this.$emit('blur', { originalEvent: event, value: input.value, valueNumber: newValue});
            ...
            this.$emit('blur-data', { originalEvent: event, value: input.value, valueNumber: newValue});
        },
        clearTimer() {
            if (this.timer) {
